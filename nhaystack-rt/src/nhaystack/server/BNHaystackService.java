 ...
 */
@NiagaraProperty(name = "showLinkedHistories", type = "boolean", defaultValue = "false")
@NiagaraProperty(name = "servlet", type = "BNHaystackServlet", defaultValue = "new BNHaystackServlet()")
@NiagaraProperty(name = "stats", type = "BNHaystackStats", defaultValue = "new BNHaystackStats()")
@NiagaraProperty(name = "timeZoneAliases", type = "BTimeZoneAliasFolder", defaultValue = "new BTimeZoneAliasFolder()")
@NiagaraProperty(name = "worker", type = "BNHaystackWorker", defaultValue = "new BNHaystackWorker()")
@NiagaraProperty(name = "watchCount", type = "int", defaultValue = "0", flags = Flags.TRANSIENT | Flags.READONLY)
@NiagaraProperty(name = "initialized", type = "boolean", defaultValue = "false", flags = Flags.TRANSIENT | Flags.READONLY)
@NiagaraProperty(name = "initializationDelayTime", type = "BRelTime", defaultValue = "BRelTime.DEFAULT")
/**
 ...
 * will be exported.
 */
@NiagaraProperty(name = "prioritizedNamespaces", type = "String", defaultValue = "hs")
@NiagaraProperty(name = "foxLeaseInterval", type = "BRelTime", defaultValue = "BRelTime.makeMinutes(2)", flags = Flags.HIDDEN)
@NiagaraProperty(name = "translateEnums", type = "boolean", defaultValue = "false", flags = Flags.HIDDEN)
@NiagaraProperty(name = "schemaVersion", type = "int", defaultValue = "0", flags = Flags.READONLY | Flags.HIDDEN)

/**
 * Lookup an entity record by it's unique identifier.
 */
@NiagaraAction(name = "readById", parameterType = "BHRef", defaultValue = "BHRef.DEFAULT", returnType = "BHDict", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * Query every entity record that matches given filter.
 */
@NiagaraAction(name = "readAll", parameterType = "BString", defaultValue = "BString.DEFAULT", returnType = "BHGrid", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * fetch all the records that are tagged as 'site'.
 */
@NiagaraAction(name = "fetchSites", returnType = "BHGrid", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * fetch all the records that are tagged as 'equip'.
 */
@NiagaraAction(name = "fetchEquips", returnType = "BHGrid", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * fetch the site-equip-point nav tree in xml format
 */
@NiagaraAction(name = "fetchSepNav", returnType = "BString", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * fetch the tags that the server auto-generates.
 */
@NiagaraAction(name = "fetchAutoGenTags", returnType = "BString", flags = Flags.OPERATOR | Flags.HIDDEN)
/**
 * find all the unique equip types
 */
@NiagaraAction(name = "findUniqueEquipTypes", parameterType = "BUniqueEquipTypeArgs", defaultValue = "new BUniqueEquipTypeArgs()", returnType = "BOrd", flags = Flags.OPERATOR | Flags.ASYNC | Flags.HIDDEN)
/**
 * apply the schedule now that the ticket has expired
 */
@NiagaraAction(name = "applySchedule", parameterType = "BHScheduleEvent", defaultValue = "new BHScheduleEvent()", flags = Flags.OPERATOR | Flags.ASYNC | Flags.HIDDEN)
/**
 * Initialize nhaystack
 */
@NiagaraAction(name = "initializeHaystack", flags = Flags.OPERATOR | Flags.ASYNC)
/**
 * Rebuild the internal cache
 */
@NiagaraAction(name = "rebuildCache", returnType = "BOrd", flags = Flags.OPERATOR | Flags.ASYNC)
/**
 * Remove all the invalid refs
 */
@NiagaraAction(name = "removeBrokenRefs", returnType = "BOrd", flags = Flags.OPERATOR | Flags.ASYNC)

/**
 * Convert haystack slot tags to Niagara tags and relations
 */
@NiagaraAction(name = "convertHaystackSlots", returnType = "BOrd", flags = Flags.OPERATOR)
 ...
 */
@NiagaraAction(name = "initializeHaystackDictionary", flags = Flags.OPERATOR | Flags.ASYNC)
public class BNHaystackService extends BAbstractService implements BINHaystackWorkerParent
{
...
////////////////////////////////////////////////////////////////
   ...
   */
  public boolean getShowLinkedHistories()
  {
    return getBoolean(showLinkedHistories);
  }
   ...
   * @see #showLinkedHistories
   */
  public void setShowLinkedHistories(boolean v)
  {
    setBoolean(showLinkedHistories, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #servlet
   */
  public BNHaystackServlet getServlet()
  {
    return (BNHaystackServlet) get(servlet);
  }
   ...
   * @see #servlet
   */
  public void setServlet(BNHaystackServlet v)
  {
    set(servlet, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #stats
   */
  public BNHaystackStats getStats()
  {
    return (BNHaystackStats) get(stats);
  }
   ...
   * @see #stats
   */
  public void setStats(BNHaystackStats v)
  {
    set(stats, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #timeZoneAliases
   */
  public BTimeZoneAliasFolder getTimeZoneAliases()
  {
    return (BTimeZoneAliasFolder) get(timeZoneAliases);
  }
   ...
   * @see #timeZoneAliases
   */
  public void setTimeZoneAliases(BTimeZoneAliasFolder v)
  {
    set(timeZoneAliases, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #watchCount
   */
  public void setWatchCount(int v)
  {
    setInt(watchCount, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   */
  public BRelTime getInitializationDelayTime()
  {
    return (BRelTime) get(initializationDelayTime);
  }
   ...
   * @see #initializationDelayTime
   */
  public void setInitializationDelayTime(BRelTime v)
  {
    set(initializationDelayTime, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   */
  public String getPrioritizedNamespaces()
  {
    return getString(prioritizedNamespaces);
  }
   ...
   * @see #prioritizedNamespaces
   */
  public void setPrioritizedNamespaces(String v)
  {
    setString(prioritizedNamespaces, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   */
  public BRelTime getFoxLeaseInterval()
  {
    return (BRelTime) get(foxLeaseInterval);
  }
   ...
   * @see #foxLeaseInterval
   */
  public void setFoxLeaseInterval(BRelTime v)
  {
    set(foxLeaseInterval, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #translateEnums
   */
  public boolean getTranslateEnums()
  {
    return getBoolean(translateEnums);
  }
   ...
   * @see #translateEnums
   */
  public void setTranslateEnums(boolean v)
  {
    setBoolean(translateEnums, v, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #readById
   */
  public BHDict readById(BHRef parameter)
  {
    return (BHDict) invoke(readById, parameter, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #readAll
   */
  public BHGrid readAll(BString parameter)
  {
    return (BHGrid) invoke(readAll, parameter, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #fetchSites
   */
  public BHGrid fetchSites()
  {
    return (BHGrid) invoke(fetchSites, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #fetchEquips
   */
  public BHGrid fetchEquips()
  {
    return (BHGrid) invoke(fetchEquips, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #fetchSepNav
   */
  public BString fetchSepNav()
  {
    return (BString) invoke(fetchSepNav, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #fetchAutoGenTags
   */
  public BString fetchAutoGenTags()
  {
    return (BString) invoke(fetchAutoGenTags, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   */
  public BOrd findUniqueEquipTypes(BUniqueEquipTypeArgs parameter)
  {
    return (BOrd) invoke(findUniqueEquipTypes, parameter, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #applySchedule
   */
  public void applySchedule(BHScheduleEvent parameter)
  {
    invoke(applySchedule, parameter, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #initializeHaystack
   */
  public void initializeHaystack()
  {
    invoke(initializeHaystack, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #rebuildCache
   */
  public BOrd rebuildCache()
  {
    return (BOrd) invoke(rebuildCache, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #removeBrokenRefs
   */
  public BOrd removeBrokenRefs()
  {
    return (BOrd) invoke(removeBrokenRefs, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #convertHaystackSlots
   */
  public BOrd convertHaystackSlots()
  {
    return (BOrd) invoke(convertHaystackSlots, null, null);
  }
...
////////////////////////////////////////////////////////////////
   ...
   * @see #initializeHaystackDictionary
   */
  public void initializeHaystackDictionary()
  {
    invoke(initializeHaystackDictionary, null, null);
  }
...
////////////////////////////////////////////////////////////////
  ...
  public void serviceStarted() throws Exception
  {
    ...
    else if (!(retryUpgradeOnRestart instanceof BBoolean) || !((BBoolean) retryUpgradeOnRestart).getBoolean())
    {
...
////////////////////////////////////////////////////////////////
  ...
  {
    if (action == initializeHaystack || action == rebuildCache || action == removeBrokenRefs || action == findUniqueEquipTypes || action == applySchedule || action == initializeHaystackDictionary)
    {
      return postAsyncChore(new WorkerInvocation(getWorker(), action.getName(), new Invocation(this, action, value, cx)));
    }
    else
    {
      return super.post(action, value, cx);
    }
  }
  ...
  {
    BUniqueEquipTypeJob job = new BUniqueEquipTypeJob(this, args.getFilter(), args.getPercentMatch(), args.getApplyTags());
    return job.submit(null);
  }

  public void doInitializeHaystackDictionary()
  {
    BHsTagDictionary hsDict = getHaystackDictionary().orElseThrow(() -> new RuntimeException(LEX.getText("haystackDictionary.notInstalled")));
...
////////////////////////////////////////////////////////////////
  ...
  public BHistoryDatabase getHistoryDb()
  {
    if (historyDb == null)
    {
      historyDb = (BHistoryDatabase) BOrd.make("history:").resolve(this, null).get();
    }
  ...
  public final BDeviceNetwork getNiagaraNetwork()
  {
    ...
    {
      niagaraNetwork = (BDeviceNetwork) NIAGARA_NETWORK.resolve(this, null).get();
    }
  ...
  private static Optional<BHsTagDictionary> getHaystackDictionary()
  {
    ...
    return service.getTagDictionary(BHsTagDictionary.HS_NAME_SPACE).filter(d -> d instanceof BHsTagDictionary).map(d -> (BHsTagDictionary) d);
  }
  ...
  public List<String> getPrioritizedNamespaceList()
  {
    ...
    for (String namespace : namespaces)
    {
      ...
      if (!trimmed.isEmpty())
      {
        if (tagDictionaryService != null)
        {
          ...
          {
            LOG.fine("NHaystackService PrioritizedNamespaces property contains namespace " + trimmed + " that does not correspond to a dictionary in the tag dictionary service. " + "This may result in tags not being exported to Haystack clients.");
          }
        }
    ...
    {
      LOG.fine("NHaystackService PrioritizedNamespaces property contains only whitespace and/or commas. " + "Defaulting to use the 'hs' namespace.");
  ...
  public HGrid getSitesGrid()
  {
    if (sites == null)
    {
      sites = doFetchSites().getGrid();
    }
...
////////////////////////////////////////////////////////////////
  ...
  public static final Logger LOG = Logger.getLogger("nhaystack");
  public static final Logger SCHEDULE_LOG = Logger.getLogger("nhaystack.schedule");
