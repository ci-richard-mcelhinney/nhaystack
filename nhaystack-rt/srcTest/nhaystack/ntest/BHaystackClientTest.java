...
////////////////////////////////////////////////////////////////
  ...
  public void testOps() throws InterruptedException
  {
    ...
    verifyColumnContains(actual, "about", "ops", "formats", "read", "nav", "watchSub", "watchUnsub", "watchPoll", "pointWrite", "hisRead", "hisWrite", "invokeAction", "extendedRead", // TODO non-standard
            EXTENDED_OP_NAME, // non-standard
            "alarmAck", "alarmRead");    // TODO non-standard
  }
  ...
  public void testFormats() throws InterruptedException
  {
    ...
    verifyColumnContains(actual, "text/zinc", "application/json", "text/csv", "text/plain");
  }
  ...
  public void testReadAll() throws InterruptedException
  {
    ...
    assertRowIds(grid, "S.SiteA", "S.SiteA.EquipA", "S.SiteA.EquipA.boolPoint", "S.SiteA.EquipA.enumPoint", "S.SiteA.EquipA.strPoint", "S.SiteA.EquipA.sineWave3", "S.SiteA.EquipA.sineWave4", "S.SiteA.EquipA.point1", "S.SiteA.EquipA.sineWave1", "S.SiteA.EquipA.sineWave2", "S.SiteB", "S.SiteB.EquipA", "S.MottsForest", "S.MottsForest.HeatPump", "C.testFolder2.Points.hp1", "C.testFolder2.Points.hp2", "C.testFolder2.Points.hp3", "H.test.LogHistory", "H.test.sineWave1");
    ...
    assertEquals(grid.row(18).get("axPointRef"), HRef.make("S.SiteA.EquipA.sineWave1"));
  ...
  public void testNav() throws Exception
  {
    ...
    assertRowIds(grid, "S.SiteA.EquipA.boolPoint", "S.SiteA.EquipA.enumPoint", "S.SiteA.EquipA.strPoint", "S.SiteA.EquipA.sineWave3", "S.SiteA.EquipA.sineWave4", "S.SiteA.EquipA.point1", "S.SiteA.EquipA.sineWave1", "S.SiteA.EquipA.sineWave2");
    ...
    assertRowDis(grid, "SiteA EquipA boolPoint", "SiteA EquipA enumPoint", "SiteA EquipA strPoint", "SiteA EquipA sineWave3", "SiteA EquipA sineWave4", "SiteA EquipA point1", "SiteA EquipA sineWave1", "SiteA EquipA sineWave2");
...
////////////////////////////////////////////////////////////////////////////
  ...
  public void testMapPointsToEquip()
  {
    ...
    assertRowIds(grid, "S.MottsForest.HeatPump.hp1", "S.MottsForest.HeatPump.hp2", "S.MottsForest.HeatPump.hp3");
  }
  ...
  public void testAddEquips()
  {
    ...
    HDict dict = new HDictBuilder().add(FUNCTION_OP_ARG_NAME, HStr.make("addEquips")).add("ids", id).add("siteName", SITE_B).add(TARGET_FILTER_OP_ARG_NAME, HStr.make("")).toDict();
...
//////////////////////////////////////////////////////////////////////////
  ...
  private static final HNum[] NUM_ARRAY = {HNum.make(10), HNum.make(20), HNum.make(30), HNum.make(40), HNum.make(50), HNum.make(60), HNum.make(70), HNum.make(80), HNum.make(90), HNum.make(100), HNum.make(110), HNum.make(120), HNum.make(130), HNum.make(140), HNum.make(150), HNum.make(160), HNum.make(170),};

  // used for Boolean point testing
  private static final HBool[] BOOL_ARRAY = {HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE, HBool.TRUE, HBool.FALSE,};

  // used for String and Enum point testing
  private static final HStr[] STR_ARRAY = {HStr.make("a1"), HStr.make("a2"), HStr.make("a3"), HStr.make("a4"), HStr.make("a5"), HStr.make("a6"), HStr.make("a7"), HStr.make("a8"), HStr.make("a9"), HStr.make("a10"), HStr.make("a11"), HStr.make("a12"), HStr.make("a13"), HStr.make("a14"), HStr.make("a15"), HStr.make("a16"), HStr.make("a17"),};
}
