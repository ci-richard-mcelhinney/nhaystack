...
////////////////////////////////////////////////////////////////////////////
    ...
    {
        try { this.client = HClient.open(URI, "baduser", "badpass"); client.about(); fail(); }
        catch(CallException ce) { verifyException(ce); }
...
//        [sep:/Blacksburg/FluxCapacitor] 'Blacksburg FluxCapacitor'
        ...
        // TODO this should be working - problem sith the generation of dis tag
