...
////////////////////////////////////////////////////////////////////////////
    ...
    private void verifyInvokeAction(HClient client) throws Exception
    {
        doVerifyInvokeAction(client, HRef.make("C.AHU2.NumericWritable"));
        doVerifyInvokeAction(client, HRef.make("S.Richmond.AHU2.NumericWritable"));
    }
    
    private void doVerifyInvokeAction(HClient client, HRef id)
    {
        HDictBuilder hd = new HDictBuilder();
        hd.add("arg", HNum.make(333));
        client.invokeAction(id, "emergencyOverride", hd.toDict());
