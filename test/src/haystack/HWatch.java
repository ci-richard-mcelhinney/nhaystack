...
public abstract class HWatch
{
   ...
   */
  public final HGrid sub(HIdentifier[] ids){ return sub(ids, true); }
   ...
   */
  public abstract HGrid sub(HIdentifier[] ids, boolean checked);

  /**
   * Remove a list of records from watch.  Silently ignore
   * any invalid ids.
   */
  public abstract void unsub(HIdentifier[] ids);
