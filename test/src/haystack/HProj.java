...
//////////////////////////////////////////////////////////////////////////
   ...
   */
  public final HDict readById(HIdentifier id)
  {
   ...
   * on checked.
   */
  public final HDict readById(HIdentifier id, boolean checked)
  {
   ...
   */
  public final HGrid readByIds(HIdentifier[] ids)
  {
   ...
   */
  public final HGrid readByIds(HIdentifier[] ids, boolean checked)
  {
   ...
   */
  protected abstract HDict onReadById(HIdentifier id);

  /**
   * Subclass hook for readByIds, return rows with nulls cells
   * for each id not found.
   */
  protected abstract HGrid onReadByIds(HIdentifier[] ids);
